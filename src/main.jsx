  ...
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="theme-icon">
      {isDark ? (
        ...
        <path d="M16.7 3.4A8.5 8.5 0 1 0 20.6 13 6.5 6.5 0 0 1 16.7 3.4Z" />
      )}
    </svg>
  );
}
...
function WhatsAppIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="whatsapp-icon">
      <path d="M12.1 3.2a8.6 8.6 0 0 0-7.4 12.9l-1 3.7 3.8-1a8.6 8.6 0 1 0 4.6-15.6Z" />
      <path d="M8.9 7.8c-.2-.5-.5-.5-.8-.5h-.6c-.2 0-.6.1-.9.4-.3.4-1.1 1.1-1.1 2.6s1.1 3 1.3 3.2c.2.3 2.1 3.4 5.3 4.6 2.6 1 3.2.8 3.7.7.6-.1 1.8-.7 2-1.4.3-.7.3-1.3.2-1.4-.1-.1-.3-.2-.7-.4l-2.1-1c-.3-.1-.6-.2-.8.2-.2.3-.9 1.1-1.1 1.3-.2.2-.4.2-.8.1-.3-.2-1.4-.5-2.7-1.7-1-1-1.7-2.1-1.9-2.4-.2-.4 0-.6.1-.8.2-.1.3-.4.5-.6.1-.2.2-.3.3-.6.1-.2 0-.4 0-.6l-.9-2.1Z" />
    </svg>
  );
}
